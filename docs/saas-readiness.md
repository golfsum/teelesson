...
| Differentiation | pass | One clear workflow difference | Today converts lesson, practice, student, communication, and revenue context into a routed Action Center and AI recommendations | Revalidate against market before launch |
...
| Information density | pass | No unnecessary drilling on Today | The coaching brief, five KPIs, complete Operations Hub, AI Coach, and Student Spotlight fit in the first large-desktop frame; the uncapped canvas expands with the window | Validate with coaches who manage larger rosters |
